<html>
    ...
    <body>
        ...
        // oturumu baslat
        session_start();
        //admin girisi yapılmamıssa admin giris sayfasına yonlendir
        ...
        //sorguyu yaziyoruz
        $sql = " SELECT uyeler.UyeId, uyeler.KullaniciAdi,uyeler.Sifre ,uyeler.UyeTel, uyeler.UyeEposta, adrestbl.AdresId, adrestbl.Ulke, adrestbl.Sehir, adrestbl.PostaKodu, adrestbl.Mahalle, adrestbl.Cadde 
        FROM ((uyeler
        ...
        while($gelen=mysqli_fetch_array($cevap)){
            ...
            // Guncellestirme
            echo "<td><a class='btn' href=_guncelle.php?id=";
            echo $gelen['UyeId'];
            echo "&no=";
            echo $gelen['AdresId'];
